...
tf.app.flags.DEFINE_string('output_dir', './train_dir',
                           'Output directory')


tf.app.flags.DEFINE_string('train_list', 'datasets/train.txt',
                           'Training list')
tf.app.flags.DEFINE_string('valid_list', 'datasets/val.txt',
                           'Test list')
